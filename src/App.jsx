  ...
  const roadmapData = {
    ...
    "KB-TKK SANTO YUSUP III": {
      "Latihan Olah-Bakat/Minat": [
        ...
        { nama: "Band & Vocalia", status: "usulan-unit" },
      ...
      "Karya Ilmiah": [
        ...
        { nama: "Science Club", status: "usulan-external" },
    ...
    "SDK SANTO YUSUP II": {
      ...
      "Karya Ilmiah": [
        { nama: "Science Club", status: "usulan-unit" },
    ...
    "SDK SANTO YUSUP III": {
      "Latihan Olah-Bakat/Minat": [
        ...
        { nama: "Band & Vocalia", status: "usulan-external-prioritas" },
    ...
    "SMPK KOLESE SANTO YUSUP 2": {
      ...
      "Karya Ilmiah": [
        ...
        { nama: "Science Club", status: "usulan-external-prioritas" },
        { nama: "Public Speaking", status: "usulan-external" },
        { nama: "Mandarin Club", status: "usulan-unit" },
        { nama: "HSK - Mandarin", status: "usulan-external" },
